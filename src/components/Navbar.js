...
const Navbar = () => {
  ...
  const fetchUsers = (email) => {
    axios.post('/findusers', { query: email })
      .then(result => {
  ...
  const renderListMobile = () => {
    if (state) {
      return [
        <MenuItem key="11"> <IconButton> <AccountCircle /> </IconButton> <p> <NavLink onClick={handleMobileMenuClose} to="/profile">Profile</NavLink> </p>  </MenuItem>,
        <MenuItem key="12"> <IconButton> <AddIcon /> </IconButton>  <p> <NavLink onClick={handleMobileMenuClose} to="/createPost">Create Post</NavLink> </p>  </MenuItem>,
        <MenuItem key="13"> <IconButton> <InsertPhotoIcon /></IconButton><p><NavLink onClick={handleMobileMenuClose} to="/myfollowingposts">My Following Posts</NavLink></p>  </MenuItem>,
        <MenuItem key="14" onClick={logout}>  <IconButton > <ExitToAppIcon /> </IconButton> Logout </MenuItem>,
      ]
    } else {
      return [
        <MenuItem key="15"> <IconButton> <AccountCircle /> </IconButton> <p> <NavLink onClick={handleMobileMenuClose} to="/login">Login</NavLink> </p>  </MenuItem>,
        <MenuItem key="16"> <IconButton> <AccountBoxIcon /> </IconButton> <p> <NavLink onClick={handleMobileMenuClose} to="/signup">Signup</NavLink> </p>  </MenuItem>,
      ]
    }
  }
  ...
  const renderListDesktop = () => {
    if (state) {
      return [
        <Button className={classes.MuiButton} key="1"> <NavLink to="/profile">Profile</NavLink> </Button>,
        <Button className={classes.MuiButton} key="2"> <NavLink to="/createPost">Create Post</NavLink> </Button>,
        <Button className={classes.MuiButton} key="6"> <NavLink to="/myfollowingposts">My Following Posts</NavLink> </Button>,
      ...
      return [
        <Button className={classes.MuiButton} key="4"> <NavLink to="/login">Login</NavLink> </Button>,
        <Button className={classes.MuiButton} key="5"> <NavLink to="/signup">Signup</NavLink> </Button>
      ]
    }
  }
  ...
  const menuofDesktop = (
    ...
    >
      ...
      <Divider />
      <MenuItem onClick={logout}>Log Out&nbsp;<ExitToAppIcon /></MenuItem>
    </Menu>
  );
